...
//  CircularProgressBar
//
//  Created by Gerardo Blanco García on 12/5/16.
...
public class StyleKit : NSObject {
    ...
    private struct Cache {
        static let topColor: UIColor = UIColor(red: 0.000, green: 0.859, blue: 0.871, alpha: 1.000)
        static let bottomColor: UIColor = UIColor(red: 0.988, green: 0.000, blue: 1.000, alpha: 1.000)
    ...
    public class func drawCircularProgressBar(progress progress: CGFloat = 0.25) {
        ...
        maskPathPath.addArcWithCenter(CGPointMake(maskPathRect.midX, maskPathRect.midY), radius: maskPathRect.width / 2, startAngle: -90 * CGFloat(M_PI)/180, endAngle: -angle * CGFloat(M_PI)/180, clockwise: true)
